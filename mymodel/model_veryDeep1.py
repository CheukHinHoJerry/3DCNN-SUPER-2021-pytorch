...
class limitRangeLayer(nn.Module):
    def __init__(self, target_min=16, target_max=234):
        super().__init__()
...
class Net(nn.Module):
    def __init__(self):
        ...
        num_of_filters_2d = 12
        num_of_filters_3d = 24
        filename = '2d_x2.mat'
        ...
        twodConvBlock1BluePrint = nn.Sequential(
            nn.ReLU(),
            nn.Conv2d(32, num_of_filters_2d, 1),
            nn.ReLU(),
        )
        twodConvBlock2BluePrint = nn.Sequential(
            nn.Conv2d(num_of_filters_2d, num_of_filters_2d, 3, padding=1),
            nn.ReLU(),
            nn.Conv2d(num_of_filters_2d, num_of_filters_2d, 3, padding=1)
        )
        twodConvBlock3BluePrint = nn.Sequential(
            nn.ReLU(),
            nn.Conv2d(num_of_filters_2d, 32, 1),
            nn.ReLU(),
        ...
        self.ResReLUList_2d = [nn.ReLU(), nn.ReLU(), nn.ReLU(), nn.ReLU(), nn.ReLU()]
        ...
        self.threedConvBlock1 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Conv3d(32, num_of_filters_3d, kernel_size=(1, 1, 3), padding=(0, 0, 1)),
            nn.ReLU()
        )
        #res 1
        self.threedConvBlock2 = nn.Sequential(
            nn.Conv3d(num_of_filters_3d, num_of_filters_3d, kernel_size=(3, 3, 3), padding=(1, 1, 1)),
            nn.ReLU(),
            nn.Conv3d(num_of_filters_3d, num_of_filters_3d, kernel_size=(3, 3, 3), padding=(1, 1, 1)),
        )

        self.ResReLUList_3d_1 = [nn.ReLU(), nn.ReLU(), nn.ReLU(), nn.ReLU(), nn.ReLU()]
        ...
        #res 2
        self.threedConvBlock4 = nn.Sequential(
            nn.Conv3d(num_of_filters_3d, num_of_filters_3d, kernel_size=(3, 3, 3), padding=(1, 1, 1)),
            nn.ReLU(),
            nn.Conv3d(num_of_filters_3d, num_of_filters_3d, kernel_size=(3, 3, 3), padding=(1, 1, 1))
        )
        self.ResReLUList_3d_2 = [nn.ReLU(), nn.ReLU(), nn.ReLU(), nn.ReLU(), nn.ReLU()]

        self.threedConvBlock5 = nn.Sequential(
            nn.ReLU(),
            nn.Conv3d(num_of_filters_3d, num_of_filters_3d, kernel_size=(3, 3, 3), padding=(1, 1, 1)),
            nn.ReLU(),
            nn.Conv3d(num_of_filters_3d, num_of_filters_3d, kernel_size=(3, 3, 3), padding=(1, 1, 1)),
            ...
            nn.Conv3d(num_of_filters_3d, num_of_filters_3d, kernel_size=(3, 3, 3), padding=(1, 1, 1)),
            nn.ReLU(),
            nn.Conv3d(num_of_filters_3d, 32, kernel_size=(1, 1, 3), padding=(0, 0, 1)),
            nn.ReLU(),
    ...
    def forward(self, input):
        ...
        for k1 in range(number_of_recursion_3d):
            x = self.threedConvBlock2(x) + x
            x = self.ResReLUList_3d_1[k1](x)

        x = self.threedConvBlock3(x)

        for k2 in range(number_of_recursion_3d):
            x = self.threedConvBlock4(x) + x
            x = self.ResReLUList_3d_2[k2](x)

        x = self.threedConvBlock5(x)
